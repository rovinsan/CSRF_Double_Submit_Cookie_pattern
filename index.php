        ...
        if (count($_POST)>0) {
            if ($_POST['uname'] != "" || $_POST['pwd'] != "") {
                if ($_POST['uname'] == "admin" && $_POST['pwd'] == "admin") {
                    ...
                    setcookie("CSRF_SESSION_COOKIE", session_id(), (time() + (3600)), "/");

                    // generateToken( $_POST['uname'] );
                    $CSRF_TOKEN = generateCSRFToken(session_id());
                    setcookie("CSRF_TOKEN_COOKIE", $CSRF_TOKEN, (time() + 10 ), '/');
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 mx-auto order-12">
                        <h4 class="text-center" style="padding-top:60px; color:white">CSRF - Double Submit Cookie Pattern</h4>
